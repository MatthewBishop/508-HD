...
public class CacheFileWorker extends FileSystem {
	...
	public CacheFileWorker(CacheFile cacheFile, CacheFile cacheFile_3_, int i, boolean bool, boolean bool_4_, boolean bool_5_) {
		super(bool, bool_4_);
		aCacheFile_2693 = cacheFile_3_;
		aBoolean2691 = bool_5_;
		anInt2687 = i;
		aCacheFile_2689 = cacheFile;
	...
	public void method164(int i, int i_0_) {
		if (method153(i_0_)) {
			if (aCacheFile_2689 == null || aBooleanArray2698 == null || !aBooleanArray2698[i_0_])
				SFSS.method633((byte) 2, 100, this, anInt2687, true, anIntArray202[i_0_], i_0_);
			else
				SFSS.method1277(-5761, this, i_0_, aCacheFile_2689);
		}
	}
	...
	public void method180(int i, int i_6_, int i_7_) {
		anInt2692 = i_7_;
		if (i != -6)
			aCacheFile_2693 = null;
		anInt2700 = i_6_;
		if (aCacheFile_2693 == null)
			SFSS.method633((byte) 0, 126, this, 255, true, anInt2692, anInt2687);
		else
			SFSS.method1277(-5761, this, anInt2687, aCacheFile_2693);
	}

	public void method182(CacheFile cacheFile, int i, byte[] is, boolean bool, byte i_8_) {
		if (i_8_ == 55) {
			if (cacheFile == aCacheFile_2693) {
				if (aBoolean2697)
				...
				if (is == null || is.length <= 2) {
					...
					if (anIntArray202[i] != i_12_ || i_13_ != anIntArray194[i]) {
						...
						if (bool)
							anObjectArray192[i] = FileSystem.wrapBuffer(false, is);
					}
				}
			}
		}
	...
	public void method183(int i, byte[] is, boolean bool, byte i_14_, boolean bool_15_) {
		...
		if (!bool) {
			...
			if (aCacheFile_2689 != null) {
				SFSS.method71(aCacheFile_2689, i, (byte) -79, is);
				aBooleanArray2698[i] = true;
			}
			if (bool_15_)
				anObjectArray192[i] = FileSystem.wrapBuffer(false, is);
			...
			if (aBoolean2697)
				throw new RuntimeException();
			if (aCacheFile_2693 != null)
				SFSS.method71(aCacheFile_2693, anInt2687, (byte) 107, is);
			method147(is);
			method185(-24792);
		}
	}
			...
			if (i == -24792) {
				for (/**/; i_24_ < aBooleanArray2698.length; i_24_++) {
					if (groupFileCount[i_24_] > 0) {
						SFSS.method2018(this, i_24_, aCacheFile_2689);
						anInt2703 = i_24_;
					}
				}
				if (anInt2703 == -1)
