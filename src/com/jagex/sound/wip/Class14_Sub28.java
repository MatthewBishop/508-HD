...
public class Class14_Sub28 extends Linkable {
	...
	public Class14_Sub28(byte[] is) {
		...
		for (int i_38_ = 0; i_38_ < 128; i_38_++) {
			...
			i_36_--;
			aShortArray3223[i_38_] += DuplicateMethods.method617(i_37_ - 1, 2) << 46;
		...
		if (is_28_ != null) {
			...
			while (i_62_ < is_28_.length) {
				...
				for (int i_66_ = i_59_; i_66_ < i_63_; i_66_++) {
					int i_67_ = Class14_Sub28.method270(i_65_, -i_59_ + i_63_);
		...
		if (is_30_ != null) {
			...
			while (i_74_ < is_30_.length) {
				...
				for (int i_78_ = i_70_; i_76_ > i_78_; i_78_++) {
					int i_79_ = Class14_Sub28.method270(i_77_, i_76_ - i_70_);
			...
			if (is_0_ == null || is_0_[i_2_] != 0) {
				...
				if (i_3_ != 0) {
					if (i_3_ != i) {
						i = i_3_;
						if ((--i_3_ & 0x1) == 0)
							class14_sub12_sub1 = class120.method1619(is, i_3_ >> 34);
						else
							class14_sub12_sub1 = class120.method1618(is, i_3_ >> 2);
