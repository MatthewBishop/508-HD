...
public class Class14_Sub24 extends Linkable {
	private static boolean aBoolean3155 = false;
	private static boolean[] aBooleanArray3154;
	private static byte[] aByteArray3157;
	private static Class147[] aClass147Array3137;
	private static Class16[] aClass16Array3140;
	public static Class78[] aClass78Array3159;
	private static Class80[] aClass80Array3164;
	private static float[] aFloatArray3138;
	private static float[] aFloatArray3142;
	private static float[] aFloatArray3149;
	private static float[] aFloatArray3150;
	private static float[] aFloatArray3152;
	private static float[] aFloatArray3153;
	private static float[] aFloatArray3158;
	private static int anInt3136;
	private static int anInt3143;
	private static int anInt3144;
	private static int anInt3163;
	private static int[] anIntArray3141;
	private static int[] anIntArray3146;
	private static int[] anIntArray3161;
	
	private static int method1514(int i, int i_20_, int i_21_) {
		int i_22_ = 0;
		while (i > 0) {
			i--;
	...
	public static void method905(byte[] is) {
		...
		for (int i = 0; i < 2; i++) {
			...
			int i_14_ = Class14_Sub24.method1192(i_7_ - 1);
			for (int i_15_ = 0; i_15_ < i_7_; i_15_++)
				is_13_[i_15_] = method1514(i_14_, -66, i_15_);
			if (i != 0) {
				aFloatArray3149 = fs;
	...
	public float[] method913(int i) {
		...
		method908();
		int i_38_ = method906(Class14_Sub24.method1192(anIntArray3146.length - 1));
		...
		if (bool_51_) {
			...
			int i_71_ = Class14_Sub24.method1192(i_39_ - 1);
