...
public class Class14_Sub9_Sub4 extends Class14_Sub9 {
	...
	public static Class14_Sub9_Sub4 method775(Class14_Sub12_Sub1 class14_sub12_sub1, int i, int i_188_) {
		...
		return new Class14_Sub9_Sub4(class14_sub12_sub1,
				(int) (class14_sub12_sub1.anInt4895 * 256L * i / (Class14_Sub9.anInt1909 * 100)),
				i_188_ << 6);
	}
	...
	private static int method740(byte[] is, int[] is_8_, int i, int i_9_, int i_10_, int i_11_, int i_12_, int i_13_,
	...
	private static int method743(int i, int i_15_, byte[] is, int[] is_16_, int i_17_, int i_18_, int i_19_, int i_20_,
	...
	private static int method744(int i, int i_28_, byte[] is, int[] is_29_, int i_30_, int i_31_, int i_32_, int i_33_,
	...
	private static int method749(int i, byte[] is, int[] is_53_, int i_54_, int i_55_, int i_56_, int i_57_, int i_58_,
	...
	private static int method750(int i, int i_63_, byte[] is, int[] is_64_, int i_65_, int i_66_, int i_67_, int i_68_,
	...
	private static int method751(int i, int i_74_, byte[] is, int[] is_75_, int i_76_, int i_77_, int i_78_, int i_79_,
	...
	private static int method752(int i, int i_84_, byte[] is, int[] is_85_, int i_86_, int i_87_, int i_88_, int i_89_,
	...
	private static int method753(int i, int i_94_, byte[] is, int[] is_95_, int i_96_, int i_97_, int i_98_, int i_99_,
	...
	private static int method754(int i, int i_105_) {
		return (i_105_ < 0 ? i : (int) (i * Math.sqrt((16384 - i_105_) * 1.220703125E-4) + 0.5));
	}
	private static int method755(int i, int i_106_, byte[] is, int[] is_107_, int i_108_, int i_109_, int i_110_,
	...
	private static int method757(byte[] is, int[] is_118_, int i, int i_119_, int i_120_, int i_121_, int i_122_,
	...
	private static int method761(int i, int i_126_, byte[] is, int[] is_127_, int i_128_, int i_129_, int i_130_,
	...
	private static int method762(int i, int i_137_) {
		return (i_137_ < 0 ? -i : (int) ((i * Math.sqrt(i_137_ * 1.220703125E-4)) + 0.5));
	}
		
	private static int method764(byte[] is, int[] is_140_, int i, int i_141_, int i_142_, int i_143_, int i_144_,
	...
	private static int method771(byte[] is, int[] is_155_, int i, int i_156_, int i_157_, int i_158_, int i_159_,
	...
	private static int method772(int i, byte[] is, int[] is_161_, int i_162_, int i_163_, int i_164_, int i_165_,
	...
	private static int method773(int i, byte[] is, int[] is_171_, int i_172_, int i_173_, int i_174_, int i_175_,
	...
	private static int method774(int i, byte[] is, int[] is_180_, int i_181_, int i_182_, int i_183_, int i_184_,
	...
	public int method766(int[] is, int i, int i_147_, int i_148_, int i_149_) {
		while (anInt4867 > 0) {
			...
			} else if (Class14_Sub9.aBoolean3763)
