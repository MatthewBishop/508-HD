...
public class Class16 {
	...
	private int[][] anIntArrayArray387;
	...
	private static boolean[] aBooleanArray393;
	private int[] anIntArray394;
	private static int[] anIntArray395 = { 256, 128, 86, 64 };
	private static float[] aFloatArray396 = { 1.0649863E-7F, 1.1341951E-7F, 1.2079015E-7F, 1.2863978E-7F, 1.369995E-7F,
	...
	private static int[] anIntArray397;
	...
	private static int method951(int[] is, int i) {
		int i_22_ = is[i];
		int i_23_ = -1;
	...
	public boolean method952() {
		...
		int i_42_ = Class14_Sub24.method1192(i_41_ - 1);
	...
	private static int method954(int[] is, int i) {
		int i_64_ = is[i];
		int i_65_ = -1;
