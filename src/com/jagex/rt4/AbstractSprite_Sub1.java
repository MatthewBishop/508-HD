...
public class AbstractSprite_Sub1 extends AbstractSprite {
	...
	public void method402(int i) {
		if (width != anInt4034 || height != anInt4046) {
			int i_58_ = i;
			if (i_58_ > offsetX)
				i_58_ = offsetX;
			int i_59_ = i;
			if (i_59_ + offsetX + width > anInt4034)
				i_59_ = anInt4034 - offsetX - width;
			int i_60_ = i;
			if (i_60_ > offsetY)
				i_60_ = offsetY;
			int i_61_ = i;
			if (i_61_ + offsetY + height > anInt4046)
				i_61_ = anInt4046 - offsetY - height;
			int i_62_ = width + i_58_ + i_59_;
			int i_63_ = height + i_60_ + i_61_;
			int[] is = new int[i_62_ * i_63_];
			for (int i_64_ = 0; i_64_ < height; i_64_++) {
				for (int i_65_ = 0; i_65_ < width; i_65_++)
					is[(i_64_ + i_60_) * i_62_ + (i_65_ + i_58_)] = pixels[i_64_ * width + i_65_];
			}
			pixels = is;
			width = i_62_;
			height = i_63_;
	...
	public void method404() {
		if (width != anInt4034 || height != anInt4046) {
			...
			for (int i = 0; i < height; i++) {
				for (int i_80_ = 0; i_80_ < width; i_80_++)
					is[(i + offsetY) * anInt4034 + (i_80_ + offsetX)] = pixels[i * width + i_80_];
			}
			pixels = is;
			width = anInt4034;
			height = anInt4046;
	...
	public void method406() {
		...
		int i = 0;
		for (int i_100_ = height - 1; i_100_ >= 0; i_100_--) {
			for (int i_101_ = 0; i_101_ < width; i_101_++)
				is[i++] = pixels[i_101_ + i_100_ * width];
		}
		pixels = is;
		offsetY = anInt4046 - height - offsetY;
	}
	...
	public void method408(int i) {
		for (int i_114_ = height - 1; i_114_ > 0; i_114_--) {
			int i_115_ = i_114_ * width;
			for (int i_116_ = width - 1; i_116_ > 0; i_116_--) {
				if (pixels[i_116_ + i_115_] == 0 && pixels[i_116_ + i_115_ - 1 - width] != 0)
					pixels[i_116_ + i_115_] = i;
			}
		}
	}
	...
	public void method410(int i, int i_134_, int i_135_) {
		for (int i_136_ = 0; i_136_ < pixels.length; i_136_++) {
			int i_137_ = pixels[i_136_];
			if (i_137_ != 0) {
				...
				if (i_140_ < 1)
					...
					i_140_ = 255;
				pixels[i_136_] = (i_138_ << 16) + (i_139_ << 8) + i_140_;
			}
		}
	}
	...
	public void method411(int i) {
		int[] is = new int[width * height];
		int i_151_ = 0;
		for (int i_152_ = 0; i_152_ < height; i_152_++) {
			for (int i_153_ = 0; i_153_ < width; i_153_++) {
				int i_154_ = pixels[i_151_];
				if (i_154_ == 0) {
					if (i_153_ > 0 && pixels[i_151_ - 1] != 0)
						i_154_ = i;
					else if (i_152_ > 0 && pixels[i_151_ - width] != 0)
						i_154_ = i;
					else if (i_153_ < width - 1 && pixels[i_151_ + 1] != 0)
						i_154_ = i;
					else if (i_152_ < height - 1 && pixels[i_151_ + width] != 0)
						i_154_ = i;
				}
				is[i_151_++] = i_154_;
			}
	...
	public void method412() {
		int[] is = new int[width * height];
		int i = 0;
		for (int i_155_ = 0; i_155_ < height; i_155_++) {
			for (int i_156_ = width - 1; i_156_ >= 0; i_156_--)
				is[i++] = pixels[i_156_ + i_155_ * width];
		}
		pixels = is;
		offsetX = anInt4034 - width - offsetX;
	}
	...
	public void method395(int i, int i_157_, int i_158_, int i_159_, int i_160_, int i_161_) {
		if (i_161_ != 0) {
			...
			int i_166_ = ((width << 4) - i) * i_163_ + -i_157_ * i_162_;
			int i_167_ = -((width << 4) - i) * i_162_ + -i_157_ * i_163_;
			int i_168_ = -i * i_163_ + ((height << 4) - i_157_) * i_162_;
			int i_169_ = --i * i_162_ + ((height << 4) - i_157_) * i_163_;
			int i_170_ = (((width << 4) - i) * i_163_ + ((height << 4) - i_157_) * i_162_);
			int i_171_ = (-((width << 4) - i) * i_162_ + ((height << 4) - i_157_) * i_163_);
			int i_172_;
			int i_173_;
			if (i_164_ < i_166_) {
				i_172_ = i_164_;
					...
					if (i_179_ == 0) {
						if (i_178_ == 0) {
							...
							while (i_184_ < 0) {
								...
								int i_187_ = i_183_;
								int i_188_ = i_173_;
								if (i_186_ >= 0 && i_187_ >= 0 && i_186_ - (width << 12) < 0
										&& i_187_ - (height << 12) < 0) {
									for (/**/; i_188_ < 0; i_188_++) {
							...
							while (i_190_ < 0) {
								...
								int i_194_ = i_173_;
								if (i_192_ >= 0 && i_192_ - (width << 12) < 0) {
									int i_195_;
									if ((i_195_ = i_193_ - (height << 12)) >= 0) {
							...
							while (i_197_ < 0) {
								...
								if (i_199_ >= 0 && i_199_ - (width << 12) < 0) {
									...
									int i_203_;
									if ((i_203_ = (i_200_ + 1 - (height << 12) - i_178_) / i_178_) > i_201_)
										i_201_ = i_203_;
									for (/**/; i_201_ < 0; i_201_++) {
						...
						if (i_178_ == 0) {
							...
							while (i_205_ < 0) {
								...
								int i_208_ = i_183_;
								int i_209_ = i_173_;
								if (i_208_ >= 0 && i_208_ - (height << 12) < 0) {
									int i_210_;
									if ((i_210_ = i_207_ - (width << 12)) >= 0) {
							...
							while (i_219_ < 0) {
								...
								if ((i_224_ = (i_222_ + 1 - (height << 12) - i_178_) / i_178_) > i_223_)
									i_223_ = i_224_;
								for (/**/; i_223_ < 0; i_223_++) {
						...
						while (i_226_ < 0) {
							...
							int i_229_ = i_183_;
							int i_230_ = i_173_;
							if (i_229_ >= 0 && i_229_ - (height << 12) < 0) {
								if (i_228_ < 0) {
								...
								int i_232_;
								if ((i_232_ = (i_228_ + 1 - (width << 12) - i_179_) / i_179_) > i_230_)
									i_230_ = i_232_;
								for (/**/; i_230_ < 0; i_230_++) {
						...
						while (i_234_ < 0) {
							...
							int i_240_;
							if ((i_240_ = (i_236_ + 1 - (width << 12) - i_179_) / i_179_) > i_238_)
								i_238_ = i_240_;
							if ((i_240_ = i_237_ - (height << 12)) >= 0) {
						...
						while (i_242_ < 0) {
							...
							int i_248_;
							if ((i_248_ = (i_244_ + 1 - (width << 12) - i_179_) / i_179_) > i_246_)
								i_246_ = i_248_;
							if (i_245_ < 0) {
							...
							if ((i_248_ = (i_245_ + 1 - (height << 12) - i_178_) / i_178_) > i_246_)
								i_246_ = i_248_;
							for (/**/; i_246_ < 0; i_246_++) {
	...
	public AbstractSprite_Sub1(int i, int i_264_, int i_265_, int i_266_, int i_267_, int i_268_, int[] is) {
		anInt4034 = i;
		anInt4046 = i_264_;
		offsetX = i_265_;
		offsetY = i_266_;
	...
	public AbstractSprite_Sub1(int i, int i_269_) {
		pixels = new int[i * i_269_];
		width = anInt4034 = i;
		height = anInt4046 = i_269_;
		offsetX = offsetY = 0;
	}
