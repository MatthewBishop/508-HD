...
public class Class14_Sub2_Sub19_Sub2 extends Class14_Sub2_Sub19 {
	...
	public Class14_Sub2_Sub19_Sub2(Class14_Sub2_Sub19_Sub1 class14_sub2_sub19_sub1) {
		...
		draw(class14_sub2_sub19_sub1.anIntArray5088);
		method422();
	}
	...
	public void method389(int i, int i_73_, int i_74_, int i_75_) {
		if (i_74_ > 0 && i_75_ > 0) {
			...
			float f_87_ = (float) (RT4GL.anInt2034 - i_73_);
			float f_88_ = f_87_ - (float) i_75_;
			float f_89_ = (float) anInt4035 / (float) width;
			float f_90_ = (float) anInt4042 / (float) height;
			gl.glBegin(6);
	...
	public void method390(int i, int i_72_) {
		...
		RT4GL.method1632(texture);
		method423(1);
		gl.glTranslatef((float) i, (float) (RT4GL.anInt2034 - i_72_), 0.0F);
	...
	public void method391(int i, int i_46_) {
		...
		RT4GL.method1632(texture);
		method423(1);
		gl.glTranslatef((float) i, (float) (RT4GL.anInt2034 - i_46_), 0.0F);
		gl.glCallList(anInt5094);
		gl.glLoadIdentity();
	}
	...
	public void method395(int i, int i_67_, int i_68_, int i_69_, int i_70_, int i_71_) {
		...
		i -= anInt4033 << 4;
		i_67_ -= anInt4050 << 4;
		gl.glTranslatef((float) i_68_ / 16.0F, (float) RT4GL.anInt2034 - (float) i_69_ / 16.0F, 0.0F);
	...
	public void method396(int i, int i_47_, int i_48_, int i_49_, int i_50_) {
		if (i_48_ > 0 && i_49_ > 0) {
			...
			float f_62_ = (float) (RT4GL.anInt2034 - i_47_);
			float f_63_ = f_62_ - (float) i_49_;
			float f_64_ = (float) anInt4035 / (float) width;
			float f_65_ = (float) anInt4042 / (float) height;
	...
	public void method400(int i, int i_9_, int i_10_, int i_11_) {
		if (i_10_ == 256)
			...
			gl.glTranslatef((float) i, (float) (RT4GL.anInt2034 - i_9_), 0.0F);
			gl.glCallList(anInt5094);
			gl.glLoadIdentity();
		}
	}
	...
	public void method419(int i, int i_2_, Class14_Sub2_Sub19_Sub2 class14_sub2_sub19_sub2_3_) {
		if (class14_sub2_sub19_sub2_3_ != null) {
			RT4GL.method1622();
			RT4GL.method1632(class14_sub2_sub19_sub2_3_.texture);
			...
			float f = ((float) (i - Class25.anInt475) / (float) class14_sub2_sub19_sub2_3_.width);
			float f_4_ = ((float) (i_2_ - Class25.anInt478) / (float) class14_sub2_sub19_sub2_3_.height);
			float f_5_ = ((float) (i + anInt4035 - Class25.anInt475) / (float) class14_sub2_sub19_sub2_3_.width);
			float f_6_ = ((float) (i_2_ + anInt4042 - Class25.anInt478) / (float) class14_sub2_sub19_sub2_3_.height);
			i += anInt4033;
			i_2_ += anInt4050;
			gl.glBegin(6);
			gl.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			float f_7_ = (float) anInt4035 / (float) width;
			float f_8_ = (float) anInt4042 / (float) height;
			gl.glMultiTexCoord2f(33985, f_5_, f_4_);
			gl.glTexCoord2f(f_7_, 0.0F);
			gl.glVertex2f((float) (i + anInt4035), (float) (RT4GL.anInt2034 - i_2_));
			gl.glMultiTexCoord2f(33985, f, f_4_);
			gl.glTexCoord2f(0.0F, 0.0F);
			gl.glVertex2f((float) i, (float) (RT4GL.anInt2034 - i_2_));
			gl.glMultiTexCoord2f(33985, f, f_6_);
			gl.glTexCoord2f(0.0F, f_8_);
			gl.glVertex2f((float) i, (float) (RT4GL.anInt2034 - (i_2_ + anInt4042)));
			gl.glMultiTexCoord2f(33985, f_5_, f_6_);
			gl.glTexCoord2f(f_7_, f_8_);
			gl.glVertex2f((float) (i + anInt4035), (float) (RT4GL.anInt2034 - (i_2_ + anInt4042)));
			gl.glEnd();
	...
	public void method420(int i, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, int i_17_, int i_18_,
		...
		if (class14_sub2_sub19_sub2_19_ != null) {
			RT4GL.method1622();
			RT4GL.method1632(class14_sub2_sub19_sub2_19_.texture);
			...
			float f = ((float) class14_sub2_sub19_sub2_19_.anInt4035 / (float) class14_sub2_sub19_sub2_19_.width);
			float f_34_ = ((float) class14_sub2_sub19_sub2_19_.anInt4042
					/ (float) class14_sub2_sub19_sub2_19_.height);
			gl.glBegin(6);
			gl.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
			float f_35_ = (float) width * 65536.0F;
			float f_36_ = (float) (height * 65536);
			gl.glMultiTexCoord2f(33985, f, 0.0F);
			gl.glTexCoord2f((float) i_28_ / f_35_, (float) i_29_ / f_36_);
			gl.glVertex2f((float) (i + i_13_), (float) (RT4GL.anInt2034 - i_12_));
			gl.glMultiTexCoord2f(33985, 0.0F, 0.0F);
			gl.glTexCoord2f((float) i_26_ / f_35_, (float) i_27_ / f_36_);
			gl.glVertex2f((float) i, (float) (RT4GL.anInt2034 - i_12_));
			gl.glMultiTexCoord2f(33985, 0.0F, f_34_);
			gl.glTexCoord2f((float) i_30_ / f_35_, (float) i_31_ / f_36_);
			gl.glVertex2f((float) i, (float) (RT4GL.anInt2034 - (i_12_ + i_14_)));
			gl.glMultiTexCoord2f(33985, f, f_34_);
			gl.glTexCoord2f((float) i_32_ / f_35_, (float) i_33_ / f_36_);
			gl.glVertex2f((float) (i + i_13_), (float) (RT4GL.anInt2034 - (i_12_ + i_14_)));
			gl.glEnd();
			gl.glTexEnvi(8960, 34161, 8448);
			gl.glTexEnvi(8960, 34176, 5890);
			gl.glDisable(3553);
	...
	public void method421(int i, int i_37_, int i_38_, int i_39_) {
		...
		RT4GL.method1632(texture);
		method423(1);
		float f = (float) anInt4035 / (float) width;
		float f_40_ = (float) anInt4042 / (float) height;
		f *= (float) i_38_;
		f_40_ *= (float) i_39_;
		int i_41_ = i + anInt4033;
		int i_42_ = i_41_ + anInt4035 * i_38_;
		int i_43_ = RT4GL.anInt2034 - i_37_ - anInt4050;
	...
	public void method422() {
		float f = (float) anInt4035 / (float) width;
		float f_45_ = (float) anInt4042 / (float) height;
		GL gl = RT4GL.gl;
		if (anInt5094 == -1) {
	...
	public void method424(int i, int i_91_, int i_92_, int i_93_, int i_94_) {
		...
		method423(1);
		float f = (float) anInt4035 / (float) width;
		float f_95_ = (float) anInt4042 / (float) height;
		f *= (float) i_93_;
		f_95_ *= (float) i_94_;
		int i_96_ = i + anInt4033;
		int i_97_ = i_96_ + anInt4035 * i_93_;
		int i_98_ = RT4GL.anInt2034 - i_91_ - anInt4050;
	...
	public void method425(int i, int i_101_, int i_102_, int i_103_, int i_104_, int i_105_) {
		...
		i -= anInt4033 << 4;
		i_101_ -= anInt4050 << 4;
		gl.glTranslatef((float) i_102_ / 16.0F, (float) RT4GL.anInt2034 - (float) i_103_ / 16.0F, 0.0F);
