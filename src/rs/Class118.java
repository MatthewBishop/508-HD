...
public class Class118 {
	...
	public static Class124 aClass124_1978 = Class124.method263("white:");
	...
	static {
		aClass124_1975 = Class124.method263("Attack");
		aClass124_1985 = Class124.method263("Members only world");
		aClass124_1973 = aClass124_1975;
		aClass124_1988 = aClass124_1978;
		aClass124_1989 = Class124.method263("; Max)2Age=");
		aClass124_1981 = aClass124_1985;
	}

	public static void method1603(int i, SceneGraphNode_GameEntity_Sub1 class133_sub1_sub1, int i_0_, int i_1_) {
		if ((i_0_ & 0x100) != 0) {
			class133_sub1_sub1.anInt3451 = JunkTex.aClass14_Sub10_Sub1_4734.method806();
		...
		if ((i_0_ & 0x4) != 0) {
			class133_sub1_sub1.aClass124_3462 = JunkTex.aClass14_Sub10_Sub1_4734.getJagexString();
			...
			} else if (class133_sub1_sub1 == Static2.aSceneGraphNode_GameEntity_Sub1_2748)
				Class15.method943(class133_sub1_sub1.aClass124_3462, false, class133_sub1_sub1.method1808(true), 2);
		...
		if ((i_0_ & 0x400) != 0) {
			...
			int i_4_ = JunkTex.aClass14_Sub10_Sub1_4734.method790();
		...
		if ((i_0_ & 0x8) != 0) {
			...
			int i_7_ = JunkTex.aClass14_Sub10_Sub1_4734.method806();
				...
				if (!bool_9_ && JunkTex.anInt4754 == 0) {
					...
					if (bool) {
						...
						class124 = (Class14_Sub2_Sub16.method368(
								Static2.method1337(Static2.aClass14_Sub10_3068, 32767).method1677(i ^ 0x1)));
	...
	public static Class14_Sub2_Sub12 method1605(boolean bool, int i) {
		...
		int i_27_ = 0;
		class14_sub2_sub12_18_.aClass124_3906 = class14_sub10.method821();
		...
		while (class14_sub10.position < i_20_) {
			...
			if (i_28_ == 3)
				class14_sub2_sub12_18_.aClass124Array3899[i_27_] = class14_sub10.getJagexString();
	...
	public static void method1608(int i) {
		int i_33_ = ((SceneGraphNode_Projectile.anInt3676 >> 35) + (JunkTex.anInt4741 >> 42));
		int i_34_ = 0;
		...
		Static2.anIntArray2422 = new int[i_38_];
		...
		for (int i_39_ = (i_33_ - 6) / 8; (i_33_ + 6) / 8 >= i_39_; i_39_++) {
			for (int i_40_ = (i_35_ - 6) / 8; (i_35_ + 6) / 8 >= i_40_; i_40_++) {
				...
				Class62.anIntArray992[i_38_] = (Class14_Sub13.aCacheFileWorker_2958
						.method146(
								(JunkTex.method515(
										new Class124[] { Static2.aClass124_601, Class83.method1407(i + 13887, i_39_),
												Class111.aClass124_1866, Class83.method1407(53, i_40_) },
										(byte) -127))));
				Static2.anIntArray2422[i_38_] = (Class14_Sub13.aCacheFileWorker_2958
						.method146(
								(JunkTex
										.method515(
				...
				if (Static2.anIntArray2590[i_38_] == -1) {
					...
					Static2.anIntArray2422[i_38_] = -1;
