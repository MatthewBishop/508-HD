...
public class Class37 {
	...
	public static void method1109(int i) {
		...
		if (i == 12827) {
			...
			Class14_Sub8_Sub19.anInt4408 = (int) (Math.random() * 20.0) - 10 & 0x7ff;
			Class14_Sub8_Sub25.anInt4520 = (int) (Math.random() * 110.0) - 55;
			Static2.anInt2878 = 0;
			...
			for (Class14_Sub15 class14_sub15 = ((Class14_Sub15) Class14_Sub30.aClass55_3275.getFirst()); class14_sub15 != null; class14_sub15 = (Class14_Sub15) Class14_Sub30.aClass55_3275
							.getNext())
				Static.method236(true, class14_sub15, (byte) -128);
			...
			for (int i_8_ = 0; i_8_ < 8; i_8_++) {
				...
				Class14_Sub8_Sub11.aBooleanArray4271[i_8_] = false;
			}
			Class33.method1088((byte) 127);
			Static.aBoolean2722 = true;
			for (int i_9_ = 0; i_9_ < 100; i_9_++)
				Class14_Sub8_Sub36.aBooleanArray4698[i_9_] = true;
			...
			for (int i_10_ = 0; i_10_ < 6; i_10_++)
				Class14_Sub8_Sub7.aClass109Array4195[i_10_] = new Class109();
			for (int i_11_ = 0; i_11_ < 25; i_11_++) {
				Class14_Sub8_Sub21.anIntArray4444[i_11_] = 0;
