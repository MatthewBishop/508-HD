...
public class SceneGraphNode_Projectile extends SceneGraphNode {
	...
	public static Class124 aClass124_3651 = Class124.method263("Oct");
	public static Class124 aClass124_3654;
	public static Class124 aClass124_3657;
	public static Class124 aClass124_3660 = Class124.method263("Dec");
	...
	static {
		aClass124_3635 = Class124.method263("gr-Un:");
		aClass124_3639 = Class124.method263("Mar");
		aClass124_3636 = Class124.method263("Nov");
		aClass124_3664 = Class124.method263("Apr");
		aBoolean3663 = false;
		aClass124_3666 = Class124.method263("Texturen geladen)3");
		aClass124_3649 = Class124.method263("Jul");
		aClass124_3632 = Class124.method263("May");
		aClass124_3637 = Class124.method263("Feb");
		aClass124_3681 = Class124.method263("Jan");
		aClass124_3654 = Class124.method263("Aug");
		aClass124_3677 = Class124.method263("Sep");
		aClass124_3657 = Class124.method263("Jun");
	...
	public static void method1854(int i, int i_17_, int i_18_) {
		...
		if (i_18_ >= 32) {
			ErrorReporting.aFrame3962 = Class138.method1950(i_17_, 95, 0, i, ErrorReporting.signlink, 0);
			if (ErrorReporting.aFrame3962 != null) {
				Static2.anInt2725 = i_17_;
				Class54.anInt887 = i;
				JunkTex.method595(ErrorReporting.signlink);
	...
	public SceneGraphNode_Projectile(int i, int i_19_, int i_20_, int i_21_, int i_22_, int i_23_, int i_24_, int i_25_, int i_26_,
			int i_27_, int i_28_) {
		anInt3641 = 0;
		anInt3670 = -32768;
		anInt3669 = i_27_;
	...
	public SceneGraphNode_AbstractModelRenderer method1850(int i) {
		...
		SceneGraphNode_AbstractModelRenderer class133_sub7_7_ = class133_sub7;
	...
	public void render(int i, int i_10_, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_, int i_16_, long l) {
		SceneGraphNode_AbstractModelRenderer class133_sub7 = method1850(-126);
		if (class133_sub7 != null) {
			class133_sub7.render(i, i_10_, i_11_, i_12_, i_13_, i_14_, i_15_, i_16_, l);
			anInt3670 = class133_sub7.getMinYorMaxYCheckTHIS();
		}
	}
}
