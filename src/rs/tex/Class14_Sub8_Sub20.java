...
public class Class14_Sub8_Sub20 extends Class14_Sub8 {
	...
	public void method475(int i, int i_21_, Buffer class14_sub10) {
		...
		while_100_: do {
			...
			anIntArray4415[2] = JunkTex.method617(i_23_ >> 12, 0);
			anIntArray4415[0] = JunkTex.method617(267386880, i_23_ << 36);
			anIntArray4415[1] = JunkTex.method617(i_23_ >> 4, 4080);
		} while (false);
		if (i_21_ != 24777)
			JunkTex.method584(71);
	}
}
