...
public class Class14_Sub8_Sub36 extends Class14_Sub8 {
	...
	public void method472() {
		aByteArray4699 = JunkTex.method527(anInt4705, (byte) -84);
		method670(11672);
	}
	...
	public int[] method484(int i, byte i_26_) {
		...
		if (aClass149_2851.aBoolean2402) {
			...
			while_51_: for (/**/; TexStatic.anInt1876 > i_31_; i_31_++) {
				JunkTex.anInt4377 = Class141.anInt2252 = Class7_Sub1.anInt2664 = Class7_Sub1.anInt2662 = 2147483647;
				...
				for (int i_35_ = i_29_ - 1; i_30_ >= i_35_; i_35_++) {
					...
					for (int i_37_ = i_33_ - 1; i_37_ <= i_34_; i_37_++) {
						...
						if (JunkTex.anInt4377 > i_42_) {
							Class7_Sub1.anInt2662 = Class7_Sub1.anInt2664;
							Class7_Sub1.anInt2664 = Class141.anInt2252;
							Class141.anInt2252 = JunkTex.anInt4377;
							JunkTex.anInt4377 = i_42_;
					...
					while_48_: do {
						do {
							if (i_43_ != 0) {
								...
								is_27_[i_31_] = JunkTex.anInt4377;
								continue while_51_;
							}
				...
				is_27_[i_31_] = -JunkTex.anInt4377 + Class141.anInt2252;
			}
		}
		if (i_26_ >= -58)
			JunkTex.method669(-115);
		is = is_27_;
		return is;
	}
	...
	public void method670(int i) {
		try {
			...
			throw JunkTex.method554(throwable, new StringBuilder("va.E(").append(i).append(')').toString());
		}
	}
}
