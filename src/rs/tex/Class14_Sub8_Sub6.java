		...
		if (aClass149_2851.aBoolean2402) {
			...
			for (;;) {
				...
				if (i_38_ != TexStatic.anInt1876) {
					...
					i_21_ = Class138.method1949(random, TexStatic.anInt1876);
					i_20_ = -i_22_ + i_21_;
					int i_58_ = i_20_;
					if (i_58_ < 0)
					...
					if (i_70_ > i_72_) {
						...
						if (anInt4170 == 0) {
							for (int i_75_ = 0; i_68_ > i_75_; i_75_++) {
								...
								is_73_[(JunkTex.method617(TexStatic.anInt4882,
										i_75_ + i))] = is_73_[(JunkTex.method617(-i_75_ + (i_62_ + i) - 1,
							...
							for (int i_77_ = 0; i_68_ > i_77_; i_77_++) {
								...
								is_73_[(JunkTex.method617(TexStatic.anInt4882,
										i + i_77_))] = is_73_[(JunkTex.method617(-i_77_ + i - 1 + i_62_,
						...
						if (i_70_ > i_80_) {
							...
							if (anInt4170 != 0) {
								for (int i_82_ = 0; i_68_ > i_82_; i_82_++) {
									...
									is_73_[(JunkTex.method617(TexStatic.anInt4882,
											i_82_ + i))] = is_73_[(JunkTex.method617(
													-i_82_ - 1 + (i_62_ + i),
								...
								for (int i_84_ = 0; i_68_ > i_84_; i_84_++) {
									...
									is_73_[(JunkTex.method617(TexStatic.anInt4882,
											i + i_84_))] = is_73_[(JunkTex.method617(i - 1 + i_62_ - i_84_,
							...
							for (int i_87_ = 0; i_68_ > i_87_; i_87_++)
								is_73_[(JunkTex
										.method617(TexStatic.anInt4882,
												i_87_ + i))] = is_73_[(JunkTex.method617(
