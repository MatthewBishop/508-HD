...
public class Class14_Sub7 extends Linkable {
	...
	public static void method469(int i, int i_0_, int i_1_, int i_2_, boolean bool, int i_3_, int i_4_) {
		...
		for (int i_5_ = -1; Static2.anInt2878 + Class14_Sub8_Sub13.anInt4306 > i_5_; i_5_++) {
			Class133_Sub1 class133_sub1;
			if (i_5_ == -1)
				class133_sub1 = Class14_Sub3.aClass133_Sub1_Sub1_2748;
			else if (Static2.anInt2878 <= i_5_)
				class133_sub1 = (Class14_Sub4.aClass133_Sub1_Sub2Array2785[(Static.anIntArray3965[-Static2.anInt2878
						+ i_5_])]);
			else
				class133_sub1 = (Class14_Sub8_Sub23.aClass133_Sub1_Sub1Array4474[Static2.anIntArray351[i_5_]]);
			if (class133_sub1 != null && class133_sub1.method1804((byte) 115)) {
					...
					if (class12.anInt306 >= 0 && (Class35.aClass14_Sub2_Sub19Array596.length > class12.anInt306)) {
						...
						if (Class120.anInt2007 > -1)
							Class35.aClass14_Sub2_Sub19Array596[class12.anInt306].method391(
									Class120.anInt2007 - 12 + i_0_, Class14_Sub8_Sub27.anInt4548 + (i_3_ - 30));
					}
						...
						if (class66 != null && class66.anInt1046 == 1
							...
							if (Class120.anInt2007 > -1)
								Class76.aClass14_Sub2_Sub19Array1191[class66.anInt1035].method391(
										Class120.anInt2007 - 12 + i_0_, Class14_Sub8_Sub27.anInt4548 + i_3_ - 28);
						}
					}
				} else {
						...
						if (Class120.anInt2007 > -1) {
							if (class133_sub1_sub1.anInt4902 != -1) {
								Class98.aClass14_Sub2_Sub19Array1669[class133_sub1_sub1.anInt4902].method391(
										Class120.anInt2007 - 12 + i_0_, (Class14_Sub8_Sub27.anInt4548 + i_3_ - i_7_));
								i_7_ += 25;
							}
							if (class133_sub1_sub1.anInt4904 != -1) {
								Class35.aClass14_Sub2_Sub19Array596[class133_sub1_sub1.anInt4904].method391(
										i_0_ + Class120.anInt2007 - 12, (Class14_Sub8_Sub27.anInt4548 + i_3_ - i_7_));
								i_7_ += 25;
							}
						}
					}
							...
							if (class66 != null && class66.anInt1046 == 10
								...
								if (Class120.anInt2007 > -1)
									Class76.aClass14_Sub2_Sub19Array1191[class66.anInt1035].method391(
											...
											(-i_7_ + Class14_Sub8_Sub27.anInt4548 + i_3_));
							}
						}
					}
				}
				if (class133_sub1.aClass124_3462 != null && (Static2.anInt2878 <= i_5_
					...
					Class150.method2022(i_1_, i_4_, -1, class133_sub1, class133_sub1.method1795(12806), i >> 33,
							i_2_ >> 1);
					if (Class120.anInt2007 > -1 && Class32.anInt549 > Class126.anInt2089) {
						...
						Class32.anIntArray534[Class126.anInt2089] = Class14_Sub8_Sub27.anInt4548;
				...
				if (Class14_Sub2_Sub20.anInt4064 < class133_sub1.anInt3450) {
					Class14_Sub2_Sub19 class14_sub2_sub19 = Class14_Sub8_Sub18.aClass14_Sub2_Sub19Array4385[0];
					Class14_Sub2_Sub19 class14_sub2_sub19_9_ = Class14_Sub8_Sub18.aClass14_Sub2_Sub19Array4385[1];
					if (class133_sub1 instanceof Class133_Sub1_Sub2) {
					...
					Class150.method2022(i_1_, i_4_, -1, class133_sub1,
							(class133_sub1.method1795(12806) + 10 + class14_sub2_sub19.anInt4042), i >> 1, i_2_ >> 33);
					if (Class120.anInt2007 > -1) {
						int i_10_ = i_0_ + (Class120.anInt2007 - (class14_sub2_sub19.anInt4035 >> 1));
						int i_11_ = i_3_ - (-Class14_Sub8_Sub27.anInt4548 + 3);
				...
				for (int i_14_ = 0; i_14_ < 4; i_14_++) {
					if (Class14_Sub2_Sub20.anInt4064 < class133_sub1.anIntArray3442[i_14_]) {
						Class150.method2022(i_1_, i_4_, -1, class133_sub1, (class133_sub1.method1795(12806) / 2),
								i >> 1, i_2_ >> 33);
						if (Class120.anInt2007 > -1) {
							if (i_14_ == 1)
							...
							Class133_Sub5.aClass14_Sub2_Sub19Array3609[class133_sub1.anIntArray3496[i_14_]].method391(
									i_0_ + Class120.anInt2007 - 12, i_3_ + Class14_Sub8_Sub27.anInt4548 - 12);
							Class56_Sub1.aClass14_Sub2_Sub16_3320.method345(
									Class83.method1407(87, (class133_sub1.anIntArray3486[i_14_])),
									Class120.anInt2007 + (i_0_ - 1), Class14_Sub8_Sub27.anInt4548 + 3 + i_3_, 16777215,
									0);
						}
					}
				}
		...
		for (int i_15_ = 0; i_15_ < Class126.anInt2089; i_15_++) {
			...
			Class14_Sub8_Sub27.anInt4548 = Class32.anIntArray534[i_15_] = i_19_;
			...
			if (Class14_Sub28.anInt3222 == 0) {
				...
				if (Class32.anIntArray537[i_15_] == 4) {
					...
					Class133_Sub3.aClass14_Sub2_Sub16_3567.method364(class124,
							-i_26_ + (i_0_ + Class120.anInt2007) + 50, Class14_Sub8_Sub27.anInt4548 + i_3_, i_22_, 0);
				...
				if (Class32.anIntArray537[i_15_] == 5) {
					...
					Class25.method1002(
							...
							i_2_ + i_0_, i_3_ + Class14_Sub8_Sub27.anInt4548 + 5);
					int i_28_ = 0;
					if (i_27_ >= 25) {
						if (i_27_ > 125)
							i_28_ = i_27_ - 125;
					...
					Class133_Sub3.aClass14_Sub2_Sub16_3567.method345(class124, Class120.anInt2007 + i_0_,
							Class14_Sub8_Sub27.anInt4548 + (i_3_ + i_28_), i_22_, 0);
					Class25.method999(i_0_, i_3_, i_0_ + i_2_, i + i_3_);
				}
			} else
				Class133_Sub3.aClass14_Sub2_Sub16_3567.method345(class124, Class120.anInt2007 + i_0_,
						i_3_ + Class14_Sub8_Sub27.anInt4548, 16776960, 0);
		}
	}

	public static void method470(Class124 class124, Class124 class124_29_, int i, Class124 class124_30_, int i_31_) {
		Class14_Sub8_Sub3.method493((byte) -97, class124, class124_30_, i_31_, class124_29_, -1);
		if (i > -124)
