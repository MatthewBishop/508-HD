...
public class Class111 {
	...
	public static void method1578(int i) {
		...
		JunkTex.anInt3931 = -1;
		for (int i_1_ = 0; i_1_ < JunkTex.aClass133_Sub1_Sub1Array4474.length; i_1_++) {
			if (JunkTex.aClass133_Sub1_Sub1Array4474[i_1_] != null)
				JunkTex.aClass133_Sub1_Sub1Array4474[i_1_].anInt3453 = -1;
		}
