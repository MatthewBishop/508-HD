...
public class Class14_Sub22 extends Linkable {
	...
	public static void method899(long l, int i) {
		if (l != 0L) {
			if (Class42.anInt698 >= 100)
				Class15.method943(Static2.aClass124_4045, false, JunkTex.aClass124_4244, 0);
			else {
				...
				for (int i_3_ = 0; Class42.anInt698 > i_3_; i_3_++) {
					if (Class126.aLongArray2095[i_3_] == l) {
						Class15.method943((JunkTex.method515(
								(new Class124[] { class124, (JunkTex.aClass124_4330) }), (byte) -14)), false,
								JunkTex.aClass124_4244, 0);
						return;
					}
				}
				for (int i_4_ = 0; Static2.anInt3728 > i_4_; i_4_++) {
					if (l == Class133_Sub1_Sub2.aLongArray4951[i_4_]) {
						Class15.method943(
								(JunkTex.method515((new Class124[] { Class138.aClass124_2226, class124,
				...
				if (class124.method1704((Class14_Sub3.aClass133_Sub1_Sub1_2748.aClass124_4922), (byte) 60))
					Class15.method943(JunkTex.aClass124_3291, false, JunkTex.aClass124_4244, 0);
				else {
					...
					JunkTex.aClass14_Sub10_Sub1_891.writeOpcode(61);
					JunkTex.aClass14_Sub10_Sub1_891.method817(l, 117);
				}
			}
		}
	}
	...
	public static void method901(byte i) {
		int i_7_ = JunkTex.aByteArrayArray4556.length;
		for (int i_8_ = 0; i_8_ < i_7_; i_8_++) {
			if (JunkTex.aByteArrayArray4556[i_8_] != null) {
				int i_9_ = -1;
				for (int i_10_ = 0; Class14_Sub2_Sub2.anInt3758 > i_10_; i_10_++) {
					if (JunkTex.anIntArray2858[i_8_] == Class120.anIntArray2009[i_10_]) {
						i_9_ = i_10_;
						break;
					}
				}
				if (i_9_ == -1) {
					Class120.anIntArray2009[Class14_Sub2_Sub2.anInt3758] = JunkTex.anIntArray2858[i_8_];
					i_9_ = Class14_Sub2_Sub2.anInt3758++;
				}
				int i_11_ = 0;
				Buffer class14_sub10 = new Buffer(JunkTex.aByteArrayArray4556[i_8_]);
				while ((JunkTex.aByteArrayArray4556[i_8_].length > class14_sub10.position) && i_11_ < 511) {
					int i_12_ = i_9_ | i_11_++ << 6;
					int i_13_ = class14_sub10.readUShort((byte) 108);
					int i_14_ = i_13_ >> 7 & 0x3f;
					int i_15_ = (i_14_ + (JunkTex.anIntArray2858[i_8_] >> 8) * 64 - Class133_Sub6.anInt3676);
					int i_16_ = i_13_ & 0x3f;
					int i_17_ = ((JunkTex.anIntArray2858[i_8_] & 0xff) * 64 + (-Class58.anInt947 + i_16_));
