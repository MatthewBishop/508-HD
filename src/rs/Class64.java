...
public class Class64 {
	...
	public static Class124 aClass124_1010 = Class124.method263("<col=ffff00>");
	...
	static {
		aClass124_1009 = Class124.method263("Versteckt");
		anIntArray1016 = new int[5];
		aClass124_1017 = Class124.method263("Choose Option");
		aLong1014 = 0L;
		anInt1012 = 0;
	...
	public static void method1286(byte i) {
		for (int i_4_ = -1; i_4_ < Static2.anInt2878; i_4_++) {
			...
			if (i_4_ != -1)
				...
				i_5_ = 2047;
			SceneGraphNode_GameEntity_Sub1 class133_sub1_sub1 = JunkTex.aSceneGraphNode_GameEntity_Sub1Array4474[i_5_];
			if (class133_sub1_sub1 != null && class133_sub1_sub1.anInt3473 > 0) {
				SceneGraphNode_GameEntity_Sub1 class133_sub1_sub1_6_ = class133_sub1_sub1;
		...
		for (int i_7_ = 0; i_7_ < JunkTex.anInt4306; i_7_++) {
			...
			if (class133_sub1_sub2 != null && class133_sub1_sub2.anInt3473 > 0) {
				SceneGraphNode_GameEntity_Sub2 class133_sub1_sub2_9_ = class133_sub1_sub2;
