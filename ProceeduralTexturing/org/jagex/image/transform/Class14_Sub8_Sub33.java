...
public class Class14_Sub8_Sub33 extends Class14_Sub8 {
	...
	public void decode(int i, Buffer class14_sub10) {
		if (i == 0)
			anInt4637 = class14_sub10.readUShort();
	}
	...
	public int[] outputMonochrome(int i) {
		...
		if (monoChromaticImageCache.empty) {
			int[] is_240_ = getOutput(0, i - 1 & TexStatic.anInt1927);
			int[] is_241_ = getOutput(0, i);
			int[] is_242_ = getOutput(0, TexStatic.anInt1927 & i + 1);
