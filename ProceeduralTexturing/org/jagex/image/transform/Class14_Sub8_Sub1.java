...
public class Class14_Sub8_Sub1 extends Class14_Sub8 {
			...
			while_199_: do {
				while_198_: do {
					do {
						...
						anInt4095 = class14_sub10.readUShort();
						break while_200_;
					} while (false);
					anInt4097 = class14_sub10.readUByte();
					break while_200_;
				} while (false);
				anInt4103 = class14_sub10.readUShort();
				break while_200_;
			} while (false);
			anInt4092 = class14_sub10.readUShort();
		} while (false);
	}
	...
	public int[] outputMonochrome(int i) {
		...
		if (monoChromaticImageCache.empty) {
			...
			int[][] is_16_ = monoChromaticImageCache.method2019();
			Random random = new Random(anInt4106);
			for (int i_17_ = 0; i_17_ < anInt4095; i_17_++) {
				int i_18_ = (anInt4092 > 0 ? (anInt4103 - i_15_ + RandomUtil.method1949(random, anInt4092))
						: anInt4103);
				int i_19_ = RandomUtil.method1949(random, TexStatic.anInt1876);
				i_18_ = i_18_ >> 4 & 0xff;
				int i_20_ = RandomUtil.method1949(random, TexStatic.anInt407);
				...
				if (i_24_ != 0 || i_23_ != 0) {
					...
					int i_32_ = (-(RandomUtil.method1949(random, 4096) >> 2) + 1024);
