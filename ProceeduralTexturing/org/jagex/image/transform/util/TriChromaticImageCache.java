...
public class TriChromaticImageCache {

	public boolean aBoolean1628 = false;
	private TriChromaticImageBuffer[] aClass14_Sub22Array1620;
	...
	public TriChromaticImageCache(int i, int i_9_, int i_10_) {
		anInt1619 = i_9_;
		aClass14_Sub22Array1620 = new TriChromaticImageBuffer[anInt1619];
		anInt1621 = i;
	...
	public int[][] method1481(int i, int i_0_) {
		if (anInt1619 == anInt1621) {
			...
			aClass14_Sub22Array1620[i_0_] = TexStatic.EMPTY_TRI_CACHE;
		...
		TriChromaticImageBuffer class14_sub22 = aClass14_Sub22Array1620[i_0_];
		if (class14_sub22 == null) {
			aBoolean1628 = true;
			if (anInt1621 <= anInt1616) {
				TriChromaticImageBuffer class14_sub22_1_ = (TriChromaticImageBuffer) aClass2_1627.getTail();
				class14_sub22 = new TriChromaticImageBuffer(i_0_, class14_sub22_1_.anInt3118);
				aClass14_Sub22Array1620[class14_sub22_1_.anInt3120] = null;
				class14_sub22_1_.unlink();
			} else {
				class14_sub22 = new TriChromaticImageBuffer(i_0_, anInt1616);
				anInt1616++;
			}
	...
	public int[][][] method1485() {
		...
		for (int i_8_ = 0; i_8_ < anInt1621; i_8_++)
			aClass14_Sub22Array1620[i_8_] = TexStatic.EMPTY_TRI_CACHE;
