...
import org.jagex.image.transform.util.MonoChromaticImageCache;
import org.jagex.image.transform.util.TriChromaticImageCache;
...
public abstract class Class14_Sub8 extends Linkable {
	...
	public int[] getOutput(int i, int i_30_) {
