...
public class Class14_Sub8_Sub32 extends Class14_Sub8 {
		...
		while_23_: do {
				...
				do {
					if (i_19_ != 0) {
						...
						anInt4625 = class14_sub10.readUShort();
						break while_23_;
					}
					anInt4611 = class14_sub10.readUShort();
					break while_23_;
				} while (false);
				anInt4621 = class14_sub10.readUShort();
		} while (false);
	}
	...
	public int[] outputMonochrome(int i) {
		...
		if (monoChromaticImageCache.empty) {
			...
			int[] is_22_ = getOutput(0, i - 1 & TexStatic.anInt1927);
			int[] is_23_ = getOutput(0, i);
			int[] is_24_ = getOutput(0, i + 1 & TexStatic.anInt1927);
