							...
							while_24_: do {
								do {
									if (i_41_ != 0) {
										...
										anInt4673 = class14_sub10.readUShort();
										break while_28_;
									}
									anInt4680 = class14_sub10.readUShort();
									break while_28_;
								} while (false);
								anInt4689 = class14_sub10.readUShort();
								break while_28_;
							} while (false);
							anInt4690 = class14_sub10.readUShort();
							break while_28_;
						} while (false);
						anInt4685 = class14_sub10.readUShort();
						break while_28_;
					} while (false);
					anInt4688 = class14_sub10.readUShort();
					break while_28_;
				} while (false);
				anInt4674 = class14_sub10.readUShort();
		} while (false);
	}
