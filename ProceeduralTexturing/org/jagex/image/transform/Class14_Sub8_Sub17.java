	...
	public int[][] outputColour(int i) {
		...
		if (triChromaticImageCache.aBoolean1628) {
			...
			for (int i_11_ = 0; i_11_ < TexStatic.anInt1876; i_11_++) {
				...
				is_8_[i_11_] = AccessoryMethods.method617(4080, i_12_ >> 44); 
 				is_9_[i_11_] = AccessoryMethods.method617(i_12_ >> 4, 4080); 
 				is_10_[i_11_] = AccessoryMethods.method617(i_12_ << 36, 4080); 
			}
		}
		int[][] is_13_ = is;
		return is_13_;
		...
		if (i == 0) {
			...
			if (i_15_ == 0) {
				...
				for (int i_16_ = 0; anIntArrayArray4376.length > i_16_; i_16_++) {
					anIntArrayArray4376[i_16_][0] = class14_sub10.readUShort();
		...
		if (i_17_ > 0) {
			for (int i_18_ = 0; i_18_ < 257; i_18_++) {
				...
				if (i_24_ < 0)
					...
					i_24_ = 255;
				anIntArray4372[i_18_] = AccessoryMethods.method1294(i_24_, AccessoryMethods.method1294(i_23_ << 40, i_22_ << 16));
			}
		}
	}

	public void method567(int i) {
		while_84_: do {
			if (i != 0) {
				int i_28_ = i;
				while_83_: do {
