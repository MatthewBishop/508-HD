...
public class Class14_Sub8_Sub29 extends Class14_Sub8 {
	...
	public int[][] outputColour(int i) {
		...
		if (triChromaticImageCache.aBoolean1628) {
			int[] is_17_ = getOutput(1, i);
			int[] is_18_ = getOutput(2, i);
			int[] is_19_ = is[0];
			int[] is_20_ = is[1];
			int[] is_21_ = is[2];
	...
	public void decode(int i, Buffer class14_sub10) {
		...
		do {
			if (i_32_ != 0) {
				...
				anInt4578 = class14_sub10.readUShort() << 4;
				break;
			}
	...
	public int[] outputMonochrome(int i) {
		...
		if (monoChromaticImageCache.empty) {
			int[] is_34_ = getOutput(1, i);
			int[] is_35_ = getOutput(2, i);
