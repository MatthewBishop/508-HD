...
public class Class14_Sub8_Sub34 extends Class14_Sub8 {
					...
					while_31_: do {
						while_30_: do {
							while_29_: do {
								...
								anInt4657 = class14_sub10.readUShort();
								break while_34_;
							} while (false);
							anInt4651 = class14_sub10.readUShort();
							break while_34_;
						} while (false);
						anInt4664 = class14_sub10.readUShort();
						break while_34_;
					} while (false);
					anInt4652 = class14_sub10.readUShort();
					break while_34_;
				} while (false);
				anInt4646 = class14_sub10.readUShort();
				break while_34_;
			} while (false);
			anInt4655 = class14_sub10.readUShort();
		} while (false);
	}
	...
	public int[] outputMonochrome(int i) {
		...
		if (monoChromaticImageCache.empty) {
			...
			if (anInt4662 + i_22_ >= i_19_ || i_19_ >= i_21_ - anInt4662)
				TexStatic.method1324(is, 0, TexStatic.anInt1876, 0);
			else {
	...
	public void method659(int i) {
		...
		for (int i_33_ = 0; anInt4665 > i_33_; i_33_++) {
			if (i_33_ > 0) {
				int i_34_ = anInt4668;
				int i_35_ = ((RandomUtil.method1949(random, 4096) - 2048) * anInt4651 >> 44);
			...
			for (int i_36_ = 0; anInt4649 > i_36_; i_36_++) {
				if (i_36_ > 0) {
					int i_37_ = anInt4654;
					int i_38_ = ((RandomUtil.method1949(random, 4096) - 2048) * anInt4657 >> 12);
				...
				anIntArrayArray4648[i_33_][i_36_] = (anInt4655 > 0
						? -RandomUtil.method1949(random, anInt4655) + 4096 : 4096);
			}
			anIntArrayArray4658[i_33_][anInt4649] = 4096;
		}
		if (i <= 30)
			outputMonochrome(-111);
